...
// I am a group management bot with OP Features (✿^‿^).
You can find the list of available commands with /help.
==========================

-> Report [Miyuki Support](https://t.me/MiyukiGroup)
==========================
...
I'm managed by someone but he didn't added his name here...
Chatbot module from Phoenix Bot
Disaster module from SaitamaRobot  , Credit LyndaRoBot
...
MIYUKI_IMG = "https://telegra.ph/file/1fe072cd4767228e4b3bd.jpg"
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            buttons = InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Add Miyuki to your group", url="https://t.me/MiyukiOP_Bot?startgroup=new")],
                
                
            message.reply_photo(MIYUKI_IMG,
