...
Hely There {}, My Name Is {} !

I Am A Group Manager Bot Maintained By [らнɪㄈ௱ЦØЛ](https://t.me/ShicmuonOP).

To add Miyuki to your group click ["HERE"](t.me/MiyukiOP_Bot?startgroup=botstart)
You can find my list of available commands with /help.



Here is the support chat if Miyuki Bot [Support Chat](http://t.me/MiyukiGroup)
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="ADD MIYUKI TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username))]]))


    else:
        update.effective_message.reply_text("I'm Busy! So Fk Off & Do Not Disturb Me.")
...
def settings_button(bot: Bot, update: Update):
    ...
    try:
        if mod_match:
            ...
            chat = bot.get_chat(chat_id)
            query.message.reply_text("Hey there! There are quite a few settings for {} - go ahead and pick what "
